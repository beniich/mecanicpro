(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_299383._.js", {
...
api.interceptors.response.use((response)=>response, async (error)=>{
    if (error.response?.status === 401) {
        if (typeof window !== 'undefined' && !window.location.pathname.startsWith('/login')) {
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/internal/auth/logout');
            } catch (e) {}
...
function LoginPage() {
    ...
    const setToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state.setToken);
    const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state.setUser);
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/internal/auth/login', {
                email,
                password
            });
            const data = res.data;
...
_s(LoginPage, "QgELCtNdy1B6/D/8XIhISrZ9t1c=", false, function() {
    return [
...
//# sourceMappingURL=_299383._.js.map