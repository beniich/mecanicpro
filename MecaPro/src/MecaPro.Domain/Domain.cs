...
public class Customer : AggregateRoot<Guid>
{
    ...
    public void AddLoyaltyPoints(int points, string reason) => Loyalty.AddPoints(points, reason);
...
public class Vehicle : AggregateRoot<Guid>
{
    ...
    public void UpdateMileage(int m) { if (m > Mileage) Mileage = m; MarkUpdated(); }
...
public class Part : AggregateRoot<Guid>
{
    ...
    public void AdjustStock(int delta) { StockQuantity += delta; MarkUpdated(); }
...
public interface IInvoiceRepository { } // placeholder
